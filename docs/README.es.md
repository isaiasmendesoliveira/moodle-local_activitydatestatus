...
- La copia de seguridad, restauración, importación y duplicación de actividades conservan la configuración de presentación de cada actividad.
...
Moodle sigue siendo la única fuente de las fechas. El complemento almacena únicamente preferencias de presentación por actividad y no duplica fechas de apertura, cierre, entrega ni reglas de acceso. Estas preferencias se incluyen en la copia de seguridad de Moodle y se restauran usando el nuevo ID del módulo del curso.
